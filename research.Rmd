...
My current work evaluates how anthropogenic stressors impact coral reef biodiversity across multiple taxonomic groups (i.e., fishes, corals, algae, microbes) in Moorea, French Polynesia. I am evaluating how the loss of fishes and nutrient pollution influence coral reef diversity using a four-year long field experiment. In addition, I am integrating observational data using new technologies (i.e, eDNA, bioacoustics, computer vision) to determine how landscape scale biodiversity is driven by fishing pressure, nutrient pollution, and heat waves. 
